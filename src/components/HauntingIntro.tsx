...
export const HauntingIntro: React.FC<HauntingIntroProps> = ({ onComplete }) => {
  ...
  // Initialize and play the haunting audio
    ...
    <div className="fixed inset-0 z-50 overflow-hidden max-h-screen">
      ...
      <div className="absolute inset-0">
        {[...Array(20)].map((_, i) => (
          ...
          >
            <div className="w-2 h-2 bg-red-500 rounded-full opacity-40 animate-ping" />
          </div>
        ))}
      </div>
      ...
      <div className="relative container mx-auto px-4 py-8 text-center min-h-screen max-h-screen overflow-y-auto flex flex-col justify-center">
        {phase === 'haunting' && (
          <div className="animate-fade-in">
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold bg-gradient-to-r from-red-500 via-orange-500 to-red-600 bg-clip-text text-transparent mb-6 animate-pulse">
              WELCOME...
            </h1>
            <p className="text-xl md:text-2xl text-red-300 mb-6 animate-pulse">
              To a realm where reality bends and breaks...
            </p>
            <div className="flex justify-center gap-4 mb-6">
              <Skull className="h-6 w-6 md:h-8 md:w-8 text-red-500 animate-pulse" />
              <Eye className="h-6 w-6 md:h-8 md:w-8 text-purple-500 animate-pulse delay-500" />
              <Skull className="h-6 w-6 md:h-8 md:w-8 text-red-500 animate-pulse delay-1000" />
            </div>
          </div>
        )}
        ...
        {showVillain && (
          <div className={`transition-all duration-1000 ${
            ...
            <div className="relative mb-6">
              ...
              <div className="relative bg-black/40 backdrop-blur-lg border-2 border-red-500/50 rounded-full p-6 mx-auto w-32 h-32 md:w-48 md:h-48 flex items-center justify-center">
            ...
            {phase === 'warning' && (
              <Card className="max-w-2xl mx-auto bg-black/60 backdrop-blur-lg border-red-500/30 animate-fade-in">
                <CardContent className="p-4 md:p-8">
                  <div className="flex justify-center mb-4">
                    <Zap className="h-8 w-8 md:h-12 md:w-12 text-red-500 animate-pulse" />
                  </div>
                  <h2 className="text-2xl md:text-3xl font-bold text-red-400 mb-4 md:mb-6">
                    THE QUANTUM VILLAIN SPEAKS
                  </h2>
                  <div className="space-y-3 md:space-y-4 text-red-200 text-base md:text-lg leading-relaxed">

      ...
      <div className="relative container mx-auto px-4 py-16 text-center min-h-screen flex flex-col justify-center">
        {phase === 'haunting' && (
          <div className="animate-fade-in">
            <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-red-500 via-orange-500 to-red-600 bg-clip-text text-transparent mb-8 animate-pulse">
              WELCOME...
            </h1>
            <p className="text-2xl text-red-300 mb-8 animate-pulse">
              To a realm where reality bends and breaks...
            </p>
            <div className="flex justify-center gap-4 mb-8">
              <Skull className="h-8 w-8 text-red-500 animate-pulse" />
              <Eye className="h-8 w-8 text-purple-500 animate-pulse delay-500" />
              <Skull className="h-8 w-8 text-red-500 animate-pulse delay-1000" />
            </div>
          </div>
        )}
        ...
        {showVillain && (
          <div className={`transition-all duration-1000 ${
            ...
            <div className="relative mb-8">
              ...
              <div className="relative bg-black/40 backdrop-blur-lg border-2 border-red-500/50 rounded-full p-8 mx-auto w-48 h-48 flex items-center justify-center">
              ...
              <Card className="max-w-2xl mx-auto bg-black/60 backdrop-blur-lg border-red-500/30 animate-fade-in">
                <CardContent className="p-8">
                  ...
                  <div className="mt-8">
                    <Button
                      onClick={onComplete}
                      className="bg-gradient-to-r from-red-600 to-purple-600 hover:from-red-700 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-full text-lg shadow-2xl transform hover:scale-105 transition-all duration-300 animate-pulse"
                    >
